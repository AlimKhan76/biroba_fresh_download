    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-strong from-green-50 to-white p-4">
      ...
      <div className="container mx-auto max-w-4xl flex-grow flex flex-col">
          ...
          <div className="prose prose-sm sm:prose lg:prose-lg mx-auto">
            ...
            <section id="terms-and-conditions">
              ...
              <ol>
                ...
                <li>
                  ...
                  <strong> BIROBA VEGETABLE SUPPLIERS, </strong>a company
                  incorporated under the Companies Act, 1956, with its
                  registered office at{" "}
                  <strong>
                    {" "}
                    ROOM 1006, MAHAKALI DARSHAN, BUILDING NO 5, GUNDAVALI
                    GAOTHAN, AZAD ROAD, ANDHERI EAST, Mumbai, India{" "}
                  </strong>
                ...
                <li>
                  ...
                  that are applicable to the Platform for such a transaction. By
                  ...
                  proposed by you which are in addition to or which conflict
                  with these Terms of Use are expressly rejected by the Platform
                  Owner and shall be of no force or effect. These Terms of Use
                  can be modified at any time without assigning any reason. It
                ...
                <li>
                  The use of the Platform and/or availing of our Services is
                  ...
                  <ol>
                    <li>
                      ...
                      done through the use of your registered account on the
                      Platform.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      entirely at your own risk and discretion for which we
                      shall not be liable to you in any manner. You are required
                      to independently assess and ensure that the Services meet
                      your requirements.
                    </li>
                    <li>
                      The contents of the Platform and the Services are
                      proprietary to us and are licensed to us. You will not
                      have any authority to claim any intellectual property
                      rights, title, or interest in its contents. The contents
                      include, but are not limited to, the design, layout, look,
                      and graphics.
                    </li>
                    <li>
                      You acknowledge that unauthorized use of the Platform
                      and/or the Services may lead to action against you as per
                    ...
                    <li>
                      You agree and acknowledge that the website and the
                      Services may contain links to other third-party websites.
                      On accessing these links, you will be governed by the
                      terms of use, privacy policy, and such other policies of
                      such third-party websites. These links are provided for
                    ...
                    <li>
                      ...
                      binding and enforceable contract with the Platform Owner
                      for the Services.
                    </li>
                    <li>
                      You shall indemnify and hold harmless the Platform Owner,
                      its affiliates, group companies (as applicable), and their
                      respective officers, directors, agents, and employees from
                      any claim or demand, or actions including reasonable
                      {"attorney's"} fees, made by any third party or penalty
                      imposed due to or arising out of your breach of these
                    ...
                    <li>
                      ...
                      the courts in <strong>Mumbai</strong> and{" "}
            ...
            <section id="privacy-policy">
              ...
              <p>
                ...
                <strong>BIROBA VEGETABLE SUPPLIERS</strong> and its affiliates
                (collectively
                ...
                Privacy Policy, the Terms of Use and the applicable service
                /product terms and conditions, and agree to be governed by the
                laws of India including but not limited to the laws applicable
                to data protection and privacy. If you do not agree please do
                not use or access our Platform.
              </p>
              <ul>
                <li>
                  <strong>Collection- </strong>We collect your personal data
                  when you use our Platform, services or otherwise interact with
                  us during the course of our relationship.and related
                  ...
                  sign-up/registering or using our Platform such as name, date
                  ...
                  <strong> BIROBA VEGETABLE SUPPLIERS</strong> seeking any
                  ...
                  report it immediately to an appropriate law enforcement
                  agency.
                </li>
                <li>
                  <strong>Usage- </strong>We use personal data to provide the
                  ...
                  products, services, and updates; customise your experience;
                  detect and protect us against error, fraud and other criminal
                  activity; enforce our terms and conditions; conduct marketing
                  research, analysis and surveys; and as otherwise described to
                  you at the time of collection of information. You understand
                  that your access to these products/services may be affected in
                  the event permission is not provided to us.
                </li>
                <li>
                ...
                <li>
                  <strong>Security Precautions- </strong> To protect your
                  personal data from unauthorised access or disclosure, loss or
                  misuse we adopt reasonable security practices and procedures.
                  Once your information is in our possession or whenever you
                  access your account information, we adhere to our security
                  guidelines to protect it against unauthorised access and offer
                  the use of a secure server. However, the transmission of
                ...
                <li>
                  <strong> Data Deletion and Retention- </strong> You have an
                  option to delete your account by visiting your profile and
                  settings on our Platform , this action would result in you
                  losing all information related to your account. You may also
                  write to us at the contact information provided below to
                  assist you with these requests. We may in event of any pending
                  grievance, claims, pending shipments or any other services we
                  may refuse or delay deletion of the account. Once the account
                  is deleted, you will lose access to the account. We retain
                ...
                <li>
                  <strong>Consent-</strong> By visiting our Platform or by
                ...
                <li>
                  ...
                  our Privacy Policy periodically for changes. We may update
                  this Privacy Policy to reflect changes to our information
                  practices. We may alert / notify you about the significant
                  changes to the Privacy Policy, in the manner as may be
                  required under applicable laws.
                </li>
                <strong>Grievance Officer</strong>
                <p>Sachin Somute</p>
                <p>
                  Biroba Vegetable Suppliers, ROOM 1006, MAHAKALI DARSHAN,
                  BUILDING NO 5, GUNDAVALI GAOTHAN, AZAD ROAD, ANDHERI EAST,
                  Mumbai, India
                </p>
                <p>
                  Contact us:
                  <ul>
                    <li>Email :birobafreshveggies@gmail.com</li>
                    <li>Phone :+91 97683 72541</li>
                  </ul>
                </p>
            ...
            <section id="refund-and-cancellation-policy">
              ...
              <ol>
                <li>
                  ...
                  within <strong>1 day </strong> of placing the order. However,
                  cancellation requests may not be entertained if the orders
                  have been communicated to such sellers/merchant(s) listed on
                  the Platform and they have initiated the process of shipping
                  them, or the product is out for delivery. In such an event,
                  you may choose to reject the product at the doorstep.
                </li>
                <li>
                  <strong>BIROBA VEGETABLE SUPPLIERS</strong> does not accept
                ...
                <li>
                  ...
                  entertained once the seller/merchant listed on the Platform
                  has checked and determined the same at its own end. This
                  should be reported within <strong>1 day </strong> of receipt
                  of products. In case you feel that the product received is not
                  as shown on the site or as per your expectations, you must
                  bring it to the notice of our customer service within{" "}
                  <strong>1 day </strong> of receiving the product. The customer
                ...
                <li>
                  ...
                  <strong>BIROBA VEGETABLE SUPPLIERS, </strong>
        ...
        <footer className="py-4 text-center text-sm text-muted-foreground">
          © 2024 Biroba Fresh. All rights reserved.
        </footer>
      </div>
    </div>
  );
